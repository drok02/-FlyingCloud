...
templatename="vmMakeTest"
time.sleep(5)
template.regiTemplate(templatename,"https://cloud-images.ubuntu.com/bionic/current/bionic-server-cloudimg-amd64.img", ubuntuTypeID, zoneid)
time.sleep(5)
